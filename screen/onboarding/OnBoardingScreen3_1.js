        ...
        <View style={{ alignItems: "center" }}>
          ...
          <View style={{ width: "100%", paddingHorizontal: 15, marginTop: 44 }}>
            <TextFieldOnBoarding text={nickname} NicknameFunction={NicknameFunction}
                                 onSubmitEditing={() => {
                                   NicknameValidCheck() && navigation.navigate("OnBoardingScreen1", { activate: 3, nickname: nickname.value });
                                 }}/>
          </View>
        </View>
        <CheckButtonRectangle text={"확인"} activate={NicknameValidCheck()}
                              disabled={!NicknameValidCheck()}
                              onPress={() => navigation.navigate('OnBoardingScreen1', {activate: 3, nickname: nickname.value})} />
      </KeyboardAvoidingView>
